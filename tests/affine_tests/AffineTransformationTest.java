...
class AffineTransformationTest {
    ...
    void scale() {
        ...
        Vector4D vector4Dw = vector3D.translationToVector4D();
        Vector3D check = AffineTransformation.scale(5, 11, -3, vector4Dw).translationToVector3D();
    ...
    void rotate() {
        Vector3D vector3D = new Vector3D(5, 4, 3);
        Vector4D vector4Dw = vector3D.translationToVector4D();
        Vector3D check = AffineTransformation.rotate(0, 0, 45, vector4Dw).translationToVector3D();
    ...
    void parallelTranslation() {
        Vector3D vector3D = new Vector3D(5, 4, 3);
        Vector4D vector4Dw = vector3D.translationToVector4D();
        Vector3D check = AffineTransformation.parallelTranslation(10,-10,0,vector4Dw).translationToVector3D();
